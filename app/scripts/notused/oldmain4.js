...
d3.chart("BaseChart").extend("FailureChart", {
    ...
    initialize: function() {
      ...
      var areaBase1 = this.base.append("g")
        .classed("area1", true);

      var lineBase1 = this.base.append("g")
        .classed("line1", true);

      var areaBase2 = this.base.append("g")
        .classed("area2", true);

      var lineBase2 = this.base.append("g")
        .classed("line2", true);

      var areaBase3 = this.base.append("g")
        .classed("area3", true);

      var lineBase3 = this.base.append("g")
        .classed("line3", true);

      var initLine = this.base.append("g")
      ...
      this.layer("totarea", areaBase1, {
        ...
        dataBind: function(data) {
          ...
          var maxest = d3.max(data, function (d) { 
        ...
        events: {
          "merge" : function() {
            ...
            var area = d3.svg.area()
              ...
              .y0(chart.height())
              .y1(function(d) { return chart.yScale(d.totMillions); });
        ...
        events: {
          "merge" : function() {
            ...
            var area = d3.svg.area()
              .x(function(d) { return chart.xScale(d.dateObject); })
              .y0(chart.height())
              .y1(function(d) { return chart.yScale(d.estMillions); });
        ...
        events: {
          "merge" : function() {
            ...
            selection
              .attr("class", "line")
              .attr("d", function(d) {
                return "M 0 " + lineY + " L " + chart.width() + " " + lineY;
              });
...
// dataToPlot.push(data[0]);
// dataToPlot.push(data[1]);
